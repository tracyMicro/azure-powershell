...
For more information, visit https://learn.microsoft.com/en-us/azure/azure-resource-manager/deployment-manager-overview'
...
CmdletsToExport = 'Get-AzDeploymentManagerArtifactSource', 
               'Get-AzDeploymentManagerRollout', 'Get-AzDeploymentManagerService', 
               'Get-AzDeploymentManagerServiceTopology', 
               'Get-AzDeploymentManagerServiceUnit', 'Get-AzDeploymentManagerStep', 
               'New-AzDeploymentManagerArtifactSource', 
               'New-AzDeploymentManagerService', 
               'New-AzDeploymentManagerServiceTopology', 
               'New-AzDeploymentManagerServiceUnit', 'New-AzDeploymentManagerStep', 
               ...
               'Set-AzDeploymentManagerServiceUnit', 'Set-AzDeploymentManagerStep', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* All operations for resources have been flagged as deprecated. Deployment manager module will be retired soon.'
