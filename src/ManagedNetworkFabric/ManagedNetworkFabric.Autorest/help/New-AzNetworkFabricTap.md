...
New-AzNetworkFabricTap -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Annotation <String>] [-Destination <INetworkTapPropertiesDestinationsItem[]>] [-Location <String>]
 [-NetworkPacketBrokerId <String>] [-PollingType <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
