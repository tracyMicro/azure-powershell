...
New-AzNetworkFabric -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Annotation <String>] [-FabricAsn <Int64>] [-Ipv4Prefix <String>] [-Ipv6Prefix <String>]
 ...
 [-ServerCountPerRack <Int32>] [-Tag <Hashtable>]
 [-TerminalServerConfiguration <ITerminalServerConfiguration>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
