...
NETWORKDEVICEINPUTOBJECT <IManagedNetworkFabricIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The ID of the target subscription. The value must be an UUID.
.Link
https://learn.microsoft.com/powershell/module/az.managednetworkfabric/remove-aznetworkfabricinterface
#>
function Remove-AzNetworkFabricInterface {
[OutputType([System.Boolean])]
[CmdletBinding(DefaultParameterSetName='Delete', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(ParameterSetName='Delete', Mandatory)]
    [Parameter(ParameterSetName='DeleteViaIdentityNetworkDevice', Mandatory)]
    ...
    [Parameter(ParameterSetName='DeleteViaIdentityNetworkDevice', Mandatory, ValueFromPipeline)]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Category('Path')]
    [Microsoft.Azure.PowerShell.Cmdlets.ManagedNetworkFabric.Models.IManagedNetworkFabricIdentity]
    # Identity Parameter
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Az.ManagedNetworkFabric.private\Remove-AzNetworkFabricInterface_Delete';
            DeleteViaIdentity = 'Az.ManagedNetworkFabric.private\Remove-AzNetworkFabricInterface_DeleteViaIdentity';
            DeleteViaIdentityNetworkDevice = 'Az.ManagedNetworkFabric.private\Remove-AzNetworkFabricInterface_DeleteViaIdentityNetworkDevice';
        }
