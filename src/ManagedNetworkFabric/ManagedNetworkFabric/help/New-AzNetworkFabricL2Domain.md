...
New-AzNetworkFabricL2Domain -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Annotation <String>] [-Location <String>] [-Mtu <Int32>] [-NetworkFabricId <String>] [-Tag <Hashtable>]
 [-VlanId <Int32>] [-DefaultProfile <PSObject>] [-AsJob] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
