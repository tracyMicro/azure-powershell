...
New-AzNetworkFabricExternalNetwork -Name <String> -L3IsolationDomainName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-Annotation <String>] [-ExportRoutePolicy <IExportRoutePolicy>]
 ...
 [-OptionAPropertyVlanId <Int32>] [-OptionBProperty <IL3OptionBProperties>] [-PeeringOption <String>]
...
New-AzNetworkFabricExternalNetwork -Name <String> -L3IsolationDomainInputObject <IManagedNetworkFabricIdentity>
 [-Annotation <String>] [-ExportRoutePolicy <IExportRoutePolicy>] [-ExportRoutePolicyId <String>]
